...
{
//#ifdef _DEBUG
//	ASSERT_MESSAGE_NULLRETURN(!mapStates_.empty(), "State machine is empty");
//#endif
//	auto& iter = mapStates_.begin();
//	currentStateName = iter->first;
}
...
HRESULT StateMachine::transitionState(int transitionCondition)
{
	...
	//ASSERT_MESSAGE_RETURN(vecTransitions_.end() != find_iter, "transition data does not exist", E_FAIL);
